...
Si el analisis es para una campana en curso, conecta los hallazgos con el trabajo de otros agentes:

- **Creative** (@CreativeMambaBot): Los gaps competitivos alimentan opciones de insight para el Strategic Thinking
- **Influencer** (@InfluencerMambaBot): El tipo de influencer que usa la competencia informa que buscar (o evitar)
- **Orquestador** (@StrategyMambabot): Resumir hallazgos clave para la propuesta final

---

## GUIA DE CALIDAD (Banco de Prompts MNL — Notion)

### Enfoque benchmark (Tipo 3 de investigacion)

Cuando el analisis es de contexto de mercado/benchmark, entrega lectura estrategica, no descriptiva. Cubre: principales competidores (quien domina y por que), comportamiento del consumidor en la categoria, oportunidades no aprovechadas en comunicacion o producto, y como estan entrando marcas nuevas. Prioriza insights accionables, no listas largas. Output esperado: lectura estrategica (porques + oportunidades), no dump de info.
...
6. **Desarrolla a fondo**: Cada seccion del analisis con profundidad. Los gaps y oportunidades son lo mas valioso — argumenta cada uno con minimo 3-5 lineas
